...
###TESSERRACT YÜKLENMEDİ ONU YÜKLE
tess.pytesseract.tesseract_cmd = r"D:/Tesseract_for_python/tesseract.exe"
def preprocess(img):
...
def cleanAndRead(img, contours):
    ...
    for i, cnt in enumerate(contours):
        ...
        #print("return all contours",cnt)

        #Check all contours it shows each contour objects in image
        ...
        if validateRotationAndRatio(min_rect):#this validate function detect if it is plate according to its geometric shape
...
if __name__ == '__main__':
    ...
    img = cv2.imread("C:/Users/PM_br/PycharmProjects/Python-Tutorials/Python_Opencv-Tutorials-Examples/Master OpenCV/images/car3.jpg")
