...
while True:
    ...
    if face_extractor(frame) is not None:
        ...
        file_name_path =os.path.dirname(os.path.dirname(os.path.dirname(os.path.join(os.getcwd(), os.listdir(os.getcwd())[0])))) \
                        +'/Master OpenCV/faces/user/image'+ str(count)+'-'+'2'+'.jpg'
